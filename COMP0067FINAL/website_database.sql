...
CREATE DATABASE IF NOT EXISTS `website_database` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
...
(3, 1, 1, 'Wells in Bangladesh', 'Built 4 wells to help vulnerable minorities near Dhaka Bangladesh.',
    'Built 4 wells in rural area of Bangladesh. We faced the following challenges. We built the following well type. The main takeaways were the following...',
 'Wells, Rural, Success', NULL, 'NGO ABCD', 'Dhaka, Bangladesh', 'John Jones',
    'johnjones@gmail.com', '+4465247890', 'ngo_website.com', '6. Clean Water and Sanitation', 'May 2009 - June 2011', 'Low', 'Rural Bengalis'),
(4, 2, 1, 'Microfinance Swaziland', 'Providing microfinance for rural people in Swaziland', 'NGO set up microfinance opportunities for rural people in Swaziland. The main achievements were... the main takeaways were...', 'Microfinance, Africa, loans',
    NULL, 'NGO ABCD', 'Swaziland, Africa', 'Jon Jones', 'johnjones@gmail.com', '+4465247890', 'ngo_website.com', '10. Reduced Inequalities',
    'December 2016 - September 2018', 'Medium', 'Rural poor in Swaziland');
...
(2, '', '', '', '', '', 0, 0, 'Admin', '21232f297a57a5a743894a0e4a801fc3', '', '', 0),
...
(15, '1', '1', '1', '1', '1@o.com', 1, 1, '1', '96e79218965eb72c92a549dd5a330112', '1', '1', 0),
(16, '1', '1', '1', '1', 'w@1.ckm', 1, 1, '1', '96e79218965eb72c92a549dd5a330112', '1', '1', 0),
(17, '1', '1', '1', '1', 'w@1.ckm', 1, 1, '1', '96e79218965eb72c92a549dd5a330112', '1', '1', 0),
...
--
ALTER TABLE `sectors`
  MODIFY `id_sectors` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
