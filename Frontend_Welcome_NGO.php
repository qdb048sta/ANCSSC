...
$count_query='SELECT COUNT(id_project) FROM projects WHERE id_user_f='.$_SESSION['user']['id_user'];
$average_budget_query='SELECT AVG(project_budget) FROM projects WHERE id_user_f='.$_SESSION['user']['id_user'];
...
;
        ...
        margin-top: 1vw;
		position:relative;
		margin-left:30%;'>Your Total Projects: ".$row['COUNT(id_project)']."</a><br></br>";
}
